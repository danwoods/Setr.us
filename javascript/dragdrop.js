...
//via: http://byramix.blogspot.com/2008/03/scriptaculous-drag-and-sort-scrolling.html
//I added this hack to disable scrolling while dragging:
//after
...
//
//so that elements classed as 'undraggable' would be that way
  ...
  initDrag: function(event) {
    ...
    if(Event.isLeftClick(event)) {
      ...
      if((tag_name = src.tagName.toUpperCase()) && (
        ...
        tag_name=='BUTTON' ||
        tag_name=='TEXTAREA')) return;
        //I added the following line, as  per above comments
        //if( src.undragable!=null) return;
